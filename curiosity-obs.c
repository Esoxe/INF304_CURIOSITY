...
int main(int argc,char **argv){
    ...
    if (argc!=3){
        printf("Arguments faux. (terrain + prog)");
        return 0;
    }
	...
	int res_obs = observ_result(&envt);

	if (res_obs) {
		printf("Le resultat 1 d'observateur est valide\n");
	} else {
		printf("Le resultat 1 d'observateur est invalide\n");
	}
}